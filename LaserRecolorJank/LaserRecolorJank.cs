...
namespace LaserRecolorJank
{
    ...
    public class Patch : ResoniteMod
    {
        ...
        class InteractionLaserJank
        {
            ...
            static void Prefix(InteractionLaser __instance, FieldDrive<color> ____startColor, FieldDrive<color> ____endColor, FieldDrive<float3> ____directPoint, FieldDrive<float3> ____actualPoint)
            {
